...
**Issue #345**: Prettify buffer contents on save. Adds two new settings, 'prettify_on_save' (true/false, default false) and 'prettify_executable' ("stylish-haskell"|"hindent").
