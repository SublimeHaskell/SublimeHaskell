...
SublimeHaskell 2.1.x is a minor release tree for minor enhancements and newly resolved issues.

## In this release

**SublimeHaskell: Run**: Make running project executables play nicely with builder execution wrappers (e.g., `cabal run`, `stack exec`, `cabal new-run`). Eliminated the 'SublimeHaskell: Stack Exec' item because all of the functionality is included in 'SublimeHaskell: Run'. This change also eliminates all of the gymnastics required to locate the executable in the first place.
